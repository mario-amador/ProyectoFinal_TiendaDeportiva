...
const Balon = ({ navigation }) => {
  const [productos, setProductos] = useState([
    { id: 1, nombre: 'Nike Academy Unisex', imagen: require('../assets/Producto18.jpg'), precio: ' 895.95', tallas: ['4', '5'], cantidad: 0, tallaSeleccionada: '' },
    { id: 2, nombre: 'Laliga 1 Accelerate Hybrid Unisex', imagen: require('../assets/Producto19.jpg'), precio: ' 875.95', tallas: ['Unica', '4'], cantidad: 0, tallaSeleccionada: '' },
    { id: 3, nombre: 'Nike Psg Strike Unisex', imagen: require('../assets/Producto20.jpg'), precio: ' 855.95', tallas: ['3','4','5'], cantidad: 0, tallaSeleccionada: '' },
    { id: 4, nombre: 'Puma Globo Neymar Jr', imagen: require('../assets/Producto21.jpg'), precio: ' 655.95', tallas: ['3','4','5'], cantidad: 0, tallaSeleccionada: '' },
    { id: 5, nombre: 'Neymar Jr Graphic Ball S3 Unisex', imagen: require('../assets/Producto22.jpg'), precio: ' 1,719.99', tallas: ['Unica', '5'], cantidad: 0, tallaSeleccionada: '' },
    { id: 6, nombre: 'Puma Orbita LaLiga 2023/24', imagen: require('../assets/Producto23.jpg'), precio: ' 1,095.95', tallas: ['4', '5'], cantidad: 0, tallaSeleccionada: '' },
  ]);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Balón de Fútbol</Text>
