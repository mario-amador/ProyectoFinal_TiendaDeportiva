...
const Equipacion = ({ navigation }) => {
  const [productos, setProductos] = useState([
    { id: 1, nombre: 'Fc Barcelona 1ª equipación 23/24', imagen: require('../assets/Producto36.jpg'), precio: ' 2,955.95', tallas: ['XS', 'S', 'M', 'L', 'XL', 'XXL', '3XL'], cantidad: 0, tallaSeleccionada: '' },
    { id: 2, nombre: 'Manchester City 3ª Equipación 23/24', imagen: require('../assets/Producto37.jpg'), precio: ' 3,155.95', tallas: ['XS', 'S', 'M', 'L', 'XL', 'XXL', '3XL'], cantidad: 0, tallaSeleccionada: '' },
    { id: 3, nombre: 'Boca Juniors 1ª Equipación 22/23', imagen: require('../assets/Producto38.jpg'), precio: ' 2,295.95', tallas: ['XS', 'S', 'M', 'L', 'XL', 'XXL', '3XL'], cantidad: 0, tallaSeleccionada: '' },
    { id: 4, nombre: 'AC Milan 1ª Equipación 23/24', imagen: require('../assets/Producto39.jpg'), precio: ' 2,155.95', tallas: ['XS', 'S', 'M', 'L', 'XL', 'XXL', '3XL'], cantidad: 0, tallaSeleccionada: '' },
    { id: 5, nombre: 'Liverpool Fc 3ª Equipación 20/21', imagen: require('../assets/Producto40.jpg'), precio: ' 1,488.99', tallas: ['XS', 'S', 'M', 'L', 'XL', 'XXL', '3XL'], cantidad: 0, tallaSeleccionada: '' },
    { id: 6, nombre: 'Real Madrid 1º Equipación 23/24', imagen: require('../assets/Producto41.png'), precio: ' 2,923.99', tallas: ['XS', 'S', 'M', 'L', 'XL', 'XXL', '3XL'], cantidad: 0, tallaSeleccionada: '' },
  ]);
