...
const TacosFutbol = ({ navigation }) => {
  const [productos, setProductos] = useState([
    { id: 1, nombre: 'Nike Mercurial Superfly 9 Club FG', imagen: require('../assets/Producto1.jpg'), precio: ' 1,747.99', tallas: ['7', '7.5', '8', '8.5', '9', '9.5', '10'], cantidad: 0, tallaSeleccionada: '' },
    { id: 2, nombre: 'Adidas Predator Accuracy.', imagen: require('../assets/Producto7.jpg'), precio: ' 1,695.95', tallas: ['7', '7.5', '8', '8.5', '9', '9.5', '10'], cantidad: 0, tallaSeleccionada: '' },
    { id: 3, nombre: 'Nike Phantom Gx Elite Fg', imagen: require('../assets/Producto8.jpg'), precio: ' 7,995.95', tallas: ['7', '7.5', '8', '8.5', '9', '9.5', '10'], cantidad: 0, tallaSeleccionada: '' },
    { id: 4, nombre: 'Nike Tiempo Legend VII Elite FG', imagen: require('../assets/Producto9.jpg'), precio: ' 1,957.99', tallas: ['7', '7.5', '8', '8.5', '9', '9.5', '10'], cantidad: 0, tallaSeleccionada: '' },
    { id: 5, nombre: 'Adidas X Crazyfast X Messi', imagen: require('../assets/Producto11.jpg'), precio: ' 3,525.95', tallas: ['7', '7.5', '8', '8.5', '9', '9.5', '10'], cantidad: 0, tallaSeleccionada: '' },
    { id: 6, nombre: 'Puma Future Z Brasil X Neymar Jr', imagen: require('../assets/Producto12.jpg'), precio: ' 2,899.99', tallas: ['7', '7.5', '8', '8.5', '9', '9.5', '10'], cantidad: 0, tallaSeleccionada: '' },
  ]);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Tacos de Fútbol</Text>
